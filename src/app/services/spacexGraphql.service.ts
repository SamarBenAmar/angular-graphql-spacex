...
export type LaunchDetailsQuery = { __typename: 'Query', launch: { __typename: 'Launch', id: string, mission_name: string, details: string, links: { __typename: 'LaunchLinks', flickr_images: Array<string> , mission_patch: string  } }  };
...
export type PastLaunchesListQuery = { __typename: 'Query', launchesPast: Array<{ __typename: 'Launch', id: string, mission_name: string, launch_date_utc: any , links: { __typename: 'LaunchLinks', flickr_images: Array<string>, mission_patch_small: string} , rocket: { __typename: 'LaunchRocket', rocket_name: string} } > };
